    ...
    <div class="container">
        <div class="row d-flex">
            ...
            <div class="col-9 pt-5">
                ...
                @can('update', $user->profile)
                    <a href="/profile/{{$user->id}}/edit" style="text-decoration: none; color: #0E0EFF">Edit Profile</a>
                @endcan
                <div class="d-flex pt-3">
                    <div class="pr-5"><strong>{{$postCount}}</strong> post(s)</div>
                    <div class="pr-5"><strong>{{$followersCount}}</strong> follower(s)</div>
                ...
                <div class="pt-4">
                    <a href="{{$user->profile->url}}" style="text-decoration: none">
                        <strong>{{$user->profile->url}}</strong>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row pt-8">
            ...
            @foreach($user->posts as $post)
                <div class="col-4 pb-4">
                    <a href="/p/{{$post->id}}">
                        <img src="/storage/{{$post->image}}" id="arcanePost">
                    </a>
                </div>
            @endforeach
