                ...
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group row">
                        ...
                        <textarea id="description"
                                  ...
                                  name="description"
                                  autocomplete="description" autofocus cols="30" rows="10">{{ old('description') ?? $user->profile->description}}</textarea>
            ...
            <div class="row pt-4">
                <div class="col-8 offset-2">
                    ...
                    <button class="btn btn-danger">
                        <a href="/profile/{{$user->id}}" style="text-decoration: none; color: #FFFFFF">
                            Cancel
                        </a>
                    </button>
                </div>
